...
public interface RideRepository extends JpaRepository<Ride, Integer > {
	...
	@Query(value = "select * from rides where ride_id in (select a.ride_id from rides_cities a join rides_cities b on "
	...
	List<Ride> getRidesFromAToB(@Param("cityA") int cityA, @Param("cityB") int cityB, @Param("date") String date);
	
	List<Ride> getByDriver(User user);
}
